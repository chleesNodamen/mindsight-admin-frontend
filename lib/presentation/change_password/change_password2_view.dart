...
import 'package:mindsight_admin_page/presentation/change_password/change_password2_controller.dart';

class ChangePassword2View extends GetWidget<ChangePassword2Controller> {
  const ChangePassword2View({super.key});
