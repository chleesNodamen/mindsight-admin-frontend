...
import 'package:mindsight_admin_page/presentation/master_manage/master_mass_register_controller.dart';

class MasterMassRegisterView extends GetWidget<MasterMassRegisterController> {
  const MasterMassRegisterView({super.key});
