...
import 'package:mindsight_admin_page/data/admin_nouse/admin_details/admin_details_repository.dart';
import 'package:mindsight_admin_page/data/admin_nouse/admin_edit/admin_edit_model.dart';
import 'package:mindsight_admin_page/data/admin_nouse/admin_edit/admin_edit_repository.dart';
import 'package:mindsight_admin_page/data/admin_nouse/admin_edit/admin_edit_req_put.dart';
...
class SubAdminEditController extends GetxController {
  ...
  Future<void> onSave() async {
    ...
    if (adminEditModel.isSuccess) {
      ...
      showSimpleMessage("Save failed ${adminEditModel.getErrorMessage().tr}");
    }
  }
}
