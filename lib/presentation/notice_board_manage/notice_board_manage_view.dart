...
class NoticeBoardManageView extends GetWidget<NoticeBoardManageController> {
  const NoticeBoardManageView({super.key});
          ...
          children: [
            SizedBox(
              ...
              child: DataTable(
                ...
                rows:
                    List.generate(controller.noticeBoardModel.length, (index) {
                  return DataRow(cells: [
                    DataCell(Text(
                      DateFormat('yyyy-MM-dd HH:mm').format(
                          controller.noticeBoardModel.createdAt![index]),
                    ...
                    DataCell(InkWell(
                      onTap: () => Get.offAllNamed(AppRoutes.noticeBoardDetail,
                          arguments: {
                            RouteArguments.id:
                                controller.noticeBoardModel.id![index]
                          }),
                      child: Text(controller.noticeBoardModel.title![index],
                          style: CustomTextStyles.bodyLargeBlack
                              .copyWith(decoration: TextDecoration.underline)),
                    )),
                    DataCell(Text(
                      controller.noticeBoardModel.views![index].toString(),
                      style: CustomTextStyles.bodyLargeBlack,
                    )),
                  ]);
                }).toList(),
            ...
            Pages(
                pages: (controller.noticeBoardModel.total! / 20).ceil(),
