...
class NoticeBoardRegisterView extends GetWidget<NoticeBoardRegisterController> {
  const NoticeBoardRegisterView({super.key});
    ...
    return Row(
      children: [
        ...
        CustomElevatedButton(
          ...
          // width: 90,
          height: 44,
          onPressed: () => Get.offAllNamed(AppRoutes.noticeBoardManage),
        ),
      ],
    );
  }
  ...
  Row _buildSubMenu() {
    return Row(
      children: [
        ...
        Text("Notice New registration".tr,
  ...
  TobBarSearch _buildTitle() {
    return TobBarSearch(
      name: "Notice New registration".tr,
      searchShow: false,
      viewCount: false,
    );
  }
