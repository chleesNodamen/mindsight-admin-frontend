...
class InquiryBoardRegisterView
    extends GetWidget<InquiryBoardRegisterController> {
  const InquiryBoardRegisterView({super.key});
    ...
    return Row(
      children: [
        ...
        CustomElevatedButton(
          ...
          // width: 90,
          height: 44,
          onPressed: () => Get.offAllNamed(AppRoutes.inquiryBoardManage),
        ),
      ],
    );
  }
