...
class FreeBoardEditView extends GetWidget<FreeBoardEditController> {
  const FreeBoardEditView({super.key});
    ...
    return Row(
      ...
      children: [
        ...
        CustomElevatedButton(
          ...
          // width: 90,
          height: 44,
          onPressed: () => Get.offAllNamed(AppRoutes.freeBoardDetail,
  ...
  Row _buildSubMenu() {
    return Row(
      children: [
        ...
        Text("Free Board Edit".tr, style: CustomTextStyles.bodyMediumGray),
      ],
    );
  }
