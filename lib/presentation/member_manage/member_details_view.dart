              ...
              children: [
                ...
                Row(
                  children: [
                    ...
                    Text('회원 상세', style: CustomTextStyles.bodyMediumGray),
                  ],
                ),
            ...
            children: [
              ...
              Column(
                ...
                children: [
                  ...
                  Text('Product Biz Dept.', style: CustomTextStyles.labelLargeBlack),
                ],
              ),
              const SizedBox(
                width: 32,
          ...
          const SizedBox(
            ...
            children: [
              Column(
                ...
                mainAxisAlignment: MainAxisAlignment.start,
                children: [
                  Text('이름 (First name)', style: CustomTextStyles.labelLargeGray),
                  const SizedBox(
                    height: 16,
                  ),
                  Text('Aiden',
